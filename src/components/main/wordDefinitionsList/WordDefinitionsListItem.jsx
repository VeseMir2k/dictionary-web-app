...
const WordDefinitionsListItem = ({ wordDefinition }) => {
  ...
  return (
    <li className="before:content mb-[13px] flex text-bodyMobileM text-textColorPrimary before:mr-[20px] before:mt-[9px] before:size-[5px] before:rounded-[50%] before:bg-purple before:pl-[5px] last-of-type:mb-0">
